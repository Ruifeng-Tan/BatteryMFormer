...
# ==========================================
model_name=BatteryMFormer_structEmbed
dataset=NA-ion
...
# Structured metadata json for structEmbed model
# Available: data_provider/structured_metadata/CALB_NA_structured_metadata.json
#            data_provider/structured_metadata/Li_ion_structured_metadata.json
#            data_provider/structured_metadata/ZNcoin_structured_metadata.json
structured_metadata_path=./data_provider/structured_metadata/CALB_NA_structured_metadata.json
...
BASE_CMD="CUDA_VISIBLE_DEVICES=$gpu_ids accelerate launch \
  ...
  --split_tag $split_tag \
  --structured_metadata_path $structured_metadata_path \
