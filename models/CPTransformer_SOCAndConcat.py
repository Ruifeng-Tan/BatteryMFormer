...
class Model(nn.Module):
    ...
    def forecast_soh_from_curves(self, cycle_curve_data, curve_attn_mask, condition_embed):
        """
    ...
    def forward(self, cycle_curve_data=None, curve_attn_mask=None,
        ...
        if self.configs.input_mode != 'current_voltage':
            ...
            output = self.forecast_soh_from_curves(cycle_curve_data, curve_attn_mask, condition_embed)
