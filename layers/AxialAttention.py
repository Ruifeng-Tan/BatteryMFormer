"""
Axial Attention for TimeMixer++
Row and Column attention for 2D time imaging

From: TimeMixer++: A General Time Series Pattern Machine for Universal Predictive Analysis
"""
import torch
...
class RowAttention(nn.Module):
    """Row-wise attention for trend extraction in time imaging"""
...
class ColAttention(nn.Module):
    """Column-wise attention for season extraction in time imaging"""
    def __init__(self, in_dim, q_k_dim):
