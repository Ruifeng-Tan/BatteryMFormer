...
if __name__ == '__main__':
    import argparse
    parser = argparse.ArgumentParser(description='MICH_EXP Dataset SOH preprocessing')
    parser.add_argument('--input', type=str, required=True, help='Input SOH directory for MICH_EXP')
    parser.add_argument('--output', type=str, required=True, help='Output processed SOH directory for MICH_EXP')
